...
namespace Blackspot.Microgestion.Backend.Entities
{
    ...
    partial void OnItemTypeIDChanged();
		...
		[Association(Name="ItemType_Item", Storage="_ItemType", ThisKey="ItemTypeID", OtherKey="ID", IsForeignKey=true)]
    ...
    partial void OnNameChanged();
		...
		[Association(Name="ItemType_Item", Storage="_Items", ThisKey="ID", OtherKey="ItemTypeID")]
